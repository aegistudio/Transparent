...
public class ShaderSymbolizer {
	...
	static final int PARAMETER_LIST_MODIFIER = 4;
	static final int PARAMETER_LIST_TYPE = 5;
	static final int PARAMETER_LIST_END = 6;
	
	static final int LOCAL = 7;
	static final int LOCAL_ADTER_TYPE = 8;
		...
		for(int i = 0; i < divisions.length; i ++) {
			...
			switch(state) {
				...
				case AFTER_GLOBAL_TYPE:
					...
					else if(tag == EnumLexicalUnit.LEFT_PARENTHESIS) {
